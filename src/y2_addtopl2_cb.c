...
#define NAMEOFADDFUNC2			addtopl2_cb
#define NAMEOFADDWAITFUNC2		waiting_populating_a2_files
...
gboolean NAMEOFADDWAITFUNC2(gpointer data) {
	(void)data;
...
static void NAMEOFADDFUNC2() {
	...
	replacenthline(pathToConfigDmelody, 9, folderNameLineToReplace);
	...
	get_strs_from_substrs_write_to_conf(fullPathToSelDir, extArr, PATHTOPLAYLIST2, "a");

	g_timeout_add_seconds(1, NAMEOFADDWAITFUNC2, NULL);
}
