...
#define NAMEOFREPLACEFUNC3		replacepl3_cb
#define PATHTOPLAYLIST3			pathToPlaylist3
#define PLAYLISTNAME3			"playlist3name="
#define NAMEOFWAITFUNC3			waiting_populating_r3_files
...
gboolean NAMEOFWAITFUNC3(gpointer data) {
	(void)data;
...
static void NAMEOFREPLACEFUNC3() {
	...
	get_strs_from_substrs_write_to_conf(fullPathToSelDir, extArr, PATHTOPLAYLIST3, "w");

	g_timeout_add_seconds(1, NAMEOFWAITFUNC3, NULL);
}
